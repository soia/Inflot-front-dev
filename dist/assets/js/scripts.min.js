(function ($) {
    ...
    window.inflot = $.extend({}, {
        ...
        initShowMoreContent: function () {
            let container = $(".container-directions"),
                wrapper = $(".wrapper-directions");

            container.each(function () {

                let content = $(this).children(wrapper);
